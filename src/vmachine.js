...
function resizePanels() {
   ...
   //Theodore Koterwas 11/5/2011: removed ' + 5' from statement which created awkward spacing
...
function toggleLineNumbers(state) {
   var mssArea = document.getElementById("mssArea");
   // var linenumbers = getElementsByClass("linenumber",mssArea,"div"); - changed by Janet 
   var linenumbers = getElementsByClass("linenumber",mssArea,"span");
